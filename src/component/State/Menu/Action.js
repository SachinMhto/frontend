...
export const getMenuItemsByRestaurantIdRequest = (reqData) => {
    return async (dispatch) => {
...
// export const getAllIngredietsOfMenuItem = (reqData) => {
//     return async (dispatch) => {
//         dispatch({ type:  });
//         try {
//             const { data } = await api.get(`/api/food/search?name=${keyword}`, {
...
export const updateMenuItemAvailability = ({ foodId, jwt }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("update menu item availability menu:", data);
