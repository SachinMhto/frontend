...
export const DELETE_RESTAURANT_REQUEST = "UPDATE_RESTAURANT_REQUEST";
export const DELETE_RESTAURANT_SUCCESS = "UPDATE_RESTAURANT_SUCCESS";
export const DELETE_RESTAURANT_FAILURE = "UPDATE_RESTAURANT_FAILURE";
...
export const GET_ALL_EVENT_REQUEST = "CREATE_EVENT_REQUEST";
export const GET_ALL_EVENT_SUCCESS = "CREATE_EVENT_SUCCESS";
export const GET_ALL_EVENT_FAILURE = "CREATE_EVENT_FAILURE";
